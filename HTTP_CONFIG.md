...
- **1.1.0-beta3**：修复 HttpClient5 版本兼容问题，配置项与行为完全不变。
  底层改用 httpclient5 5.1.x ~ 5.6.x 全区间共有的 API，因此本文所有配置项在
  Spring Boot 2.7.x / 3.x、JDK 8/11/17/21 下表现一致。
  注意 `1.1.0` / `1.1.0-beta` / `1.1.0-beta2` 三个版本在 Spring Boot 2.7.x 下会启动报错，请使用 beta3
